...
load('siso_UAss_10zoh.mat');
[A,B,C,D] = ssdata(siso_UAss_10zoh);
nA = length(A);
...
% Initialization
[X_0,xbar,sigmas,relerr,abserr] = setup11(nx);
Pbar0 = diag(sigmas.^2);
dXbar0 = xbar';
X_0 = X_0';
if exist('x0hist2.mat')
    load('x0hist2.mat');
    [row,col] = size(x0_mat);
    X_0 = x0_mat(:,col);
end
...
save('xseqsle02.mat','X_0','xbar','sigmas');
